...
namespace S2021A6QP.Controllers
{
    public class Manager
    {
        ...
        public ArtistWithMediaInfoViewModel ArtistGetByIdWithMediaInfoViewModel(int id)
        {
        ...
        public AlbumBaseViewModel AlbumAdd(AlbumAddViewModel newAlbum)
        {
            ...
            return mapper.Map<Album, AlbumBaseViewModel>(addedAlbum);
        }
        ...
        public TrackMediaViewModel TrackMediaGetByID(int id)
        {
            var track = ds.Tracks.Find(id);
        ...
        public TrackBaseViewModel TrackAdd(TrackAddViewModel newTrack)
        {
            ...
            addedTrack.Media = MediaBytes;
            addedTrack.MediaContentType = newTrack.MediaUpload.ContentType;
            ...
            return mapper.Map<Track, TrackBaseViewModel>(addedTrack);
        }
        ...
        {
            var deleteTrack = ds.Tracks.Find(id);
        ...
        public ArtistBaseViewModel ArtistMediaItemAdd(ArtistMediaItemAddViewModel newArtistMediaItem)
        {
            ...
            var addedArtistMediaItem = new ArtistMediaItem();
            ds.ArtistMediaItems.Add(addedArtistMediaItem);

            addedArtistMediaItem.Caption = newArtistMediaItem.Caption;
            addedArtistMediaItem.Artist = artist;
            ...
            addedArtistMediaItem.Content = MediaBytes;
            addedArtistMediaItem.ContentType = newArtistMediaItem.MediaUpload.ContentType;
